"""
Refer to github.com/gem5bootcamp/2024/02-Using-gem5/09-sampling/03-SMARTS/complete/SMARTS.py
-----------------------------------------------------------
n : the number of the samples.
k : the systematic sampling interval.
U : the sampling unit size, number of instructions executed.
W : the length of the detailed warm up period, number of instructions executed.
-----------------------------------------------------------
gem5 -re SMARTS.py
"""
