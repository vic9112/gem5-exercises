...
from component.ring import Ring
...
class PrivateL1SharedL2CacheHierarchy(AbstractRubyCacheHierarchy):
    ...
    def incorporate_cache(self, board):
        ...
        self.ruby_system.network = Ring(self.ruby_system)
        ...
        # Create a L2/Home nodes sliced by the 7th bit
        self.l2caches = [
            SharedL2(
                size=self._l2_size,
        ...
        for l2 in self.l2caches:
            l2.downstream_destinations = self.memory_controllers
        ...
        self.ruby_system.network.connectControllers(
            l1d_ctrls=[cluster.dcache for cluster in self.core_clusters],
            l1i_ctrls=[cluster.icache for cluster in self.core_clusters],
            l2_ctrls=self.l2caches,
            mem_ctrls=self.memory_controllers,
        ...
        self.ruby_system.sys_port_proxy.ruby_system = self.ruby_system # ADDED
    ...
    def _create_core_cluster(
        ...
        cluster.icache.sequencer.ruby_system = self.ruby_system # ADDED
        cluster.dcache.sequencer.ruby_system = self.ruby_system # ADDED
        ...
        cluster.dcache.downstream_destinations = self.l2caches
        cluster.icache.downstream_destinations = self.l2caches
    ...
    def _create_dma_controllers(
        ...
        for i, port in enumerate(board.get_dma_ports()):
            ...
            ctrl.downstream_destinations = self.l2caches
